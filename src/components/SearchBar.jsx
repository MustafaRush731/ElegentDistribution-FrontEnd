            ...
            <div className="fixed w-[100%] shadow-none outline-none border-0">
                <div className="bg-white shadow border-b border-gray pt-4 pb-6">
                    <div className="container mx-auto flex justify-center md:px-5">
                        ...
                        <div className="flex my-auto ml-[20px] -mr-[100px] text-[20px]">
                            ...
                            <a href="#" className="relative px-3 group">
                                <i class="lar la-user">
                ...
                <nav className=" bg-white shadow pt-4 z-0">
                    <ul className="container mx-auto flex justify-center">
                        <li><a href="#" className="relative tracking-[1px] text-[14px] mr-[30px] after:absolute after:content-[''] after:bg-yellow-500 after:h-[3px] after:w-[0%] after:left-0 after:-bottom-[3px] after:rounded-xl after:duration-300 hover:after:w-[100%]">HOME</a></li>
                        ...
                        <li><a href="#" className="relative tracking-[1px] text-[14px] mr-[30px] after:absolute after:content-[''] after:bg-yellow-500 after:h-[3px] after:w-[0%] after:left-0 after:-bottom-[3px] after:rounded-xl after:duration-300 hover:after:w-[100%]">CHOCOLATES</a></li>
                        <li><a href="#" className="relative tracking-[1px] text-[14px] mr-[30px] after:absolute after:content-[''] after:bg-yellow-500 after:h-[3px] after:w-[0%] after:left-0 after:-bottom-[3px] after:rounded-xl after:duration-300 hover:after:w-[100%]">CHIPS</a></li>
                        <li><a href="#" className="relative tracking-[1px] text-[14px] mr-[30px] after:absolute after:content-[''] after:bg-yellow-500 after:h-[3px] after:w-[0%] after:left-0 after:-bottom-[3px] after:rounded-xl after:duration-300 hover:after:w-[100%]">COOKIES</a></li>
                    </ul>
                </nav>
            </div>
        </>
