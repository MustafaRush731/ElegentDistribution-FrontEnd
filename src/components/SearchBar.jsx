    ...
    return(
        <>
            <div className="bg-white shadow border-b border-gray pt-4 pb-6">
                <div className="container mx-auto flex justify-between item-center px-40 md:px-5">
                    ...
                    <div className="flex items-center w-full max-w-[250px] sm:max-w-[300px] md:max-w-[400px] lg:max-w-[550px] xl:max-w-[850px]">
                        <input
                            type="text"
            ...
            <nav className="bg-white shadow pt-4">
                <ul className="container mx-auto flex justify-between px-20">
                    <li><a href="#" className="relative tracking-[1px] text-[14px] font-bold after:absolute after:content-[''] after:bg-yellow-500 after:h-[3px] after:w-[0%] after:left-0 after:-bottom-[3px] after:rounded-xl after:duration-300 hover:after:w-[100%]">HOME</a></li>
                    <li><a href="#" className="relative tracking-[1px] text-[14px] font-bold after:absolute after:content-[''] after:bg-yellow-500 after:h-[3px] after:w-[0%] after:left-0 after:-bottom-[3px] after:rounded-xl after:duration-300 hover:after:w-[100%]">CANDY</a></li>
                    <li><a href="#" className="relative tracking-[1px] text-[14px] font-bold after:absolute after:content-[''] after:bg-yellow-500 after:h-[3px] after:w-[0%] after:left-0 after:-bottom-[3px] after:rounded-xl after:duration-300 hover:after:w-[100%]">CHOCOLATES</a></li>
                    <li><a href="#" className="relative tracking-[1px] text-[14px] font-bold after:absolute after:content-[''] after:bg-yellow-500 after:h-[3px] after:w-[0%] after:left-0 after:-bottom-[3px] after:rounded-xl after:duration-300 hover:after:w-[100%]">CHIPS</a></li>
                    <li><a href="#" className="relative tracking-[1px] text-[14px] font-bold after:absolute after:content-[''] after:bg-yellow-500 after:h-[3px] after:w-[0%] after:left-0 after:-bottom-[3px] after:rounded-xl after:duration-300 hover:after:w-[100%]">COOKIES</a></li>
                </ul>
            </nav>
        </>
    )
