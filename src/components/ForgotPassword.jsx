...
export default function ForgotPassword(){
    ...
    return (
        <div className='h-screen'>
            ...
            <div className="container max-w-[500px] mx-auto flex flex-col">
                <span className='font-bold text-[30px] '>Forgot Password</span>
                <input
                    type = "text"
                ...
                <button className='rounded-3xl bg-black mt-[40px] text-white pt-[5px] pb-[5px] w-[60%] mx-auto' onClick={handleResetPasswordClick}>
                    Reset Password
                </button>
            </div>
        </div>
