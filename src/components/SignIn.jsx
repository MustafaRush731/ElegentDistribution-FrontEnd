        ...
        <>
            ...
            <div className="relative w-[100%]">
                <div className="container flex flex-col mx-auto justify-center mt-[30px]">
                    ...
                    <button className='bg-blue-500 mx-auto w-[400px] mt-[20px] border rounded-2xl pt-[10px] pb-[10px] text-[15px] font-bold text-white'>
                        <i className="fa-brands fa-square-facebook"></i>
                        Continue with Facebook
                    </button>
                    <button className='bg-white-500 mx-auto w-[400px] mt-[20px] border rounded-2xl pt-[10px] pb-[10px] text-[15px] font-bold text-black'>
...
{/* <div className="absolute w-[100%] mt-[200px] z-0">
            <div className="container flex mx-auto justify-center">
                <div className="flex flex-col mr-[70px] w-[35%]">
                    <div className="text-[30px] text-left font-bold">
                        Login
                    </div>
                    <div className="flex flex-col pb-[10px]">
                        <div className="flex flex-row text-[18px] text-gray-500 font-bold">
                            Username or email address
                            <i class="fa-solid fa-asterisk pl-[5px] text-[10px] text-red-500 mt-[4px]"></i>
                        </div>
                        <input
                                type="text"
                                className="flex-grow p-2 border max-w-[5000px] border-gray-300 rounded-md focus:outline-none"
                        />
                    </div>
                    <div className="flex flex-col pb-[10px]">
                        <div className="flex flex-row text-[18px] text-gray-500 font-bold">
                    ...
                    <button className="bg-yellow-500 w-[100%] text-white mt-[20px] pt-[10px] pb-[10px]">
                        LOGIN
                    </button>
                </div>
